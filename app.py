...
def analyser_bulletin():
    ...
    for fichier in fichiers:
        ...
        try:
            ...
            nb_matieres_trouvees = len(donnees_structurees.get("appreciations_matieres", []))
            if nb_matieres_trouvees != nb_matieres_attendu:
                erreurs.append(f"Validation échouée : {nb_matieres_trouvees} matières trouvées sur {nb_matieres_attendu} attendues.")
            ...
            **Partie 2 : Justifications**
            ...
            resultat_eleve["erreur_validation"] = f"ERREUR CRITIQUE: {e}"

...
def analyser_bulletin():
    ...
    for fichier in fichiers:
        ...
        try:
            ...
            print(f"Erreur lors de la lecture de {fichier.filename}: {e}")
            continue # On passe au fichier suivant en cas d'erreur de lecture
        finally:
        ...
        try:
            ...
            **Partie 2 : Justifications**
            ...
            justifications = "Aucune justification disponible."
        
        # On ajoute le résultat complet pour cet élève à notre liste globale
